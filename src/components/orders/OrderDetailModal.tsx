    ...
    <Dialog open={!!order} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-md p-0 overflow-hidden">
        <div className="p-6">
          ...
          {/* Meta info */}
          <div className="mt-4 space-y-2 rounded-lg bg-secondary/30 p-3 text-sm">
                ...
                {order.items.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md bg-gradient-to-br from-primary/20 to-accent">
                        ☕
                      </div>
          ...
          {/* Summary */}
          <div className="mt-4 space-y-2 rounded-lg bg-secondary/30 p-4 text-sm">
          ...
          {!isVoided && !showConfirmVoid && (
            <Button
              variant="outline"
              className="w-full mt-4 text-destructive hover:text-destructive hover:border-destructive/50"
